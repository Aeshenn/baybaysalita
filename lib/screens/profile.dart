                      ...
                      child: Container(
                        width: 150,
                          child: CircleAvatar(
                            radius: 60,
                            backgroundColor: Colors.transparent,
                            backgroundImage: AssetImage('lib/img/letters/student.jpg'),
                          ),
                          decoration: BoxDecoration(
                                shape: BoxShape.circle,
                                border: Border.all(
                                  color: 
                                  Color(0xfff5505b).withOpacity(.5),
                                  width: 5.0,
                                  )
                                )
                              ),
                                        ...
                                        Container(
                                         ...
                                         SizedBox(
                                            ...
                                            child:  GFProgressBar(
                                                  ...
                                                  leading  :  Icon( Icons.sentiment_dissatisfied, color: Color.fromARGB(255, 237, 20, 5)),
                                                  trailing:  Icon( Icons.sentiment_satisfied, color: Color.fromARGB(255, 27, 171, 31)),
